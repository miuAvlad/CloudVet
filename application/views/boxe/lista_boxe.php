                    ...
                    <div class="card border-left-primary shadow h-100 py-2">
                        <div class="card-header bg-light position-sticky top-0">
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="p mb-0 font-weight-bold text-gray-600">Nume: <?= $boxa->boxa_nume ?><br> Locatie: <?= $boxa->boxa_locatie ?><br> Capacitate: <?= @$boxa->nr_caini ?>/<?= $boxa->capacitate ?></br></br></div>
                                ...
                                <div class="col mr-2">
                                    ...
                                    <?php foreach ($boxa->caini as $caine) : ?>
                                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                            <?= @$caine->NrCip ?> - Varsta:  Talie(<?= $caine->Talie ?>) Caracter(<?= $caine->Caracter ?>)
